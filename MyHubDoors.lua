...
OtherTab:AddButton({
	Name = "New God Mode",
	Callback = function()
      		game.Players.LocalPlayer.Character.Collision.Position -= Vector3.new(0,10,0)
  	end    
})

OtherTab:AddToggle({
	Name = "Field Of View Enable",
	Default = false,
	Callback = function(Value)
		_G.FOVHack = Value
	end    
...
BypassTab:AddButton({
    Name = "Speed Bypass",
    Callback = function()
        loadstring(game:HttpGet("https://raw.github.com/finngameandglitch/bypass/main/bypass"))()
    end
})
...
BypassTab:AddButton({
    ...
    Callback = function()
        ...
        PlayerGui.MainUI.ItemShop:Destroy()
        require(PlayerGui.MainUI.Initiator.Main_Game).freemouse = false
	end
})
